...
ifeq ($(DOCKER_ENV),false)
    ...
    go test -timeout -30s github.com/da-moon/coe865-final/internal/header -run TestBasicEncrypt -v \
    "
	- exit 
endif
...
ifeq ($(DOCKER_ENV),false)
	- @$(MAKE) --no-print-directory -f $(THIS_FILE) shell cmd=" GO111MODULE=${MOD}\
       CGO_ENABLED=${CGO} \
    GOARCH=${GO_ARCHITECTURE} \
    go test -timeout -30s github.com/da-moon/coe865-final/internal/header -run TestHeaderLength -v \
    "
	- exit 
endif
ifeq ($(DOCKER_ENV),true)
