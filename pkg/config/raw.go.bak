...
func (c *ConfigFactory) DecodeRawConfig(r io.Reader) (*Config, error) {
	fmt.Println("DecodeRawConfig called")
	...
	fmt.Printf("DecodeRawConfig self %#v\n", self)
	fmt.Printf("DecodeRawConfig connectedRouteControllers %#v\n", connectedRouteControllers)
	fmt.Printf("DecodeRawConfig connectedAutonomousSystems %#v\n", connectedAutonomousSystems)
